...
(function() {
  var Store, async, clone, fs, get, getIDs, getObjectFromFile, getObjectFromFileSync, id2fileName, isJSONFile, mkdirp, path, readIDs, readIDsSync, remove, removeFileExtension, save, saveObjectToFile, uuid;
  ...
  remove = function(id, cb) {
    ...
    if (this._single) {
      ...
      if (cb != null) {
        return saveObjectToFile(this._cache, file, done);
      } else {
        err = (o = saveObjectToFile(this._cache, file)) instanceof Error;
        return done(err, o);
      }
    } else {
      done = function(err) {
        if (err != null) {
          return ((typeof cb === "function" ? cb(cb(err)) : void 0) ? void 0 : err);
        }
  ...
  Store = (function() {
    ...
    Store.prototype._getFileName = function(id) {
      if (this._single) {
        return "" + this._dir + "/" + (path.basename(this.name)) + ".json";
      } else {
    ...
    Store.prototype.all = function(cb) {
      ...
      if (this._single) {
        ...
        return readIDs(this._dir, function(err, ids) {
